...
namespace ContosoUniversity.Controllers
{
    public class EstudianteController : Controller
    {
        ...
        public async Task<IActionResult> Index(string sortOrder, string currentFilter, string searchString, int? pageNumber)
        {
            ...
            var students = from s in _context.Estudiantes
                           select s;
            ...
            switch (sortOrder)
            {
                case "name_desc":
                    ...
                    break;
                case "Date":
                    students = students.OrderBy(s => s.FechaInscripcion);
                    break;
                case "date_desc":
                    students = students.OrderByDescending(s => s.FechaInscripcion);
                    break;
                default:
            ...
            int pageSize = 3;
            return View(await PaginatedList<Estudiante>.CreateAsync(students.AsNoTracking(), pageNumber ?? 1, pageSize));
